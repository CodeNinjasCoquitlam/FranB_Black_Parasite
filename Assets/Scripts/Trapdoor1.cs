...
public class Trapdoor1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(inputToInteract) && can == true)
        {
            print("ok");
            can = false;
            can2 = false;
            trapdoor.transform.position = new Vector3(trapdoor.transform.position.x, trapdoor.transform.position.y + 15, trapdoor.transform.position.z);
        }
    }
