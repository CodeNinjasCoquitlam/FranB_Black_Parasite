...
public class Jump2 : MonoBehaviour
{
   ...
   // public float JumpsBeforeEnd = 0;
    ...
    void Update()
    {
        ...
        {
            var tmp = 255;
            iconImage.GetComponent<Image>().color = new Color(255, 255, 255, tmp);
            infoText.GetComponent<Text>().text = DoubleJump + " Double Jumps Remaining";
        }
        if(DoubleJump == 0 && infoText.GetComponent<Text>().text == "1 Double Jumps Remaining")
        {
            var tmp = 0;
            iconImage.GetComponent<Image>().color = new Color(255, 255, 255, tmp);
        ...
        if (Jumps >= 2 && infoText.GetComponent<Text>().text == DoubleJump + " Double Jumps Remaining")
        {
            infoText.GetComponent<Text>().text = "";
        }
